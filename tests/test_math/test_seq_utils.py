...
from pydesigntools.mathutil import fmod_sequence, ratio_sequence, round_sequence, scale_sequence


class TestScaleSequence(unittest.TestCase):
    def test_scale_sequence(self):
        data = (
            (((1, 2, 3, 4, 5), 6, 2), (2, 4, 6, 8, 10)),
            (((1.0, 2.0, 3.0), 10.0, 0), (10.0, 20.0, 30.0)),
            (((1, 2, 3, 4, 5), 0.5),
             (0.16666666666666666, 0.33333333333333331, 0.5, 0.66666666666666663, 0.83333333333333326))
        )
...
class TestRatioSequence(unittest.TestCase):
...
class TestFModSequence(unittest.TestCase):
